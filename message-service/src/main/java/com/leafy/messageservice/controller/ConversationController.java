...
import com.leafy.messageservice.dto.request.AddMembersRequest;
...
import com.leafy.messageservice.dto.request.MarkAsReadRequest;
import com.leafy.messageservice.dto.request.UpdateGroupSettingsRequest;
import com.leafy.messageservice.dto.request.UpdateJoinQuestionRequest;
...
import com.leafy.messageservice.service.conversation.GroupConversationService;
...
public class ConversationController {
    ...
    @PatchMapping(value = "/{conversationId}/avatar")
    ...
    public ResponseEntity<ApiResponse<ConversationResponse>> updateGroupAvatar(
        ...
        return ResponseEntity.ok(ApiResponse.success(
                groupConversationService.updateGroupAvatar(conversationId, avatarUrl)));
    }
    ...
    @Operation(summary = "Pin a conversation for the current user (max 5)")
    ...
    @DeleteMapping("/{conversationId}/pin-conversation")
