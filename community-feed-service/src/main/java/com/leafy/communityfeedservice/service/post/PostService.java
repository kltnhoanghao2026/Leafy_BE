...
public interface PostService {
    ...
    Page<PostResponse> getPostsByUserId(String profileId, Pageable pageable);
    Page<PostResponse> getPersonalizedFeed(String profileId, Pageable pageable);
    PostResponse updatePost(String id, PostUpdateRequest request);
    void deletePost(String id);
    void markPostAsViewed(String profileId, String postId);
}
